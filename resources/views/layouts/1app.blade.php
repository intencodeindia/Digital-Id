                            ...
                            <div class="col-lg-6">
                                <div class="d-flex justify-content-center">
                                    <div class="d-flex fw-semibold flex-column me-20">
                                        ...
                                        <a href="https://proffid.com/faqs" class="text-gray-700 text-hover-primary fs-5 mb-6">FAQ</a>
                                        ...
                                        <a href="https://devs.proffid.com/" class="text-gray-700 text-hover-primary fs-5 mb-6">Support Forum</a>
                                        <a href="https://proffid.com/blog" class="text-gray-700 text-hover-primary fs-5">Blog</a>
                                    </div>
                    ...
                    <div class="container">
                        <div class="d-flex flex-column flex-md-row flex-stack py-8">
                            ...
                            <ul class="menu menu-gray-700 menu-hover-primary fw-semibold fs-5 fs-md-5 order-1 mb-5 mb-md-0">
                                ...
                                <li class="menu-item"><a href="https://proffid.com/" target="_blank" class="menu-link px-2">Purchase</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
