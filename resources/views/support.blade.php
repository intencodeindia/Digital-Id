            ...
            <div class="mb-9 pt-15 z-index-2">
                <div class="container">
                    <h3 class="fs-lg-2tx fs-2x text-gray-900 text-center mb-16 lh-base" id="how-it-works">
                        Transform Your Organization's Identity into the Digital Age
                    </h3>
                    <div class="fs-5 fw-semibold text-gray-600 mt-4">
                        <!--begin::Text-->
                        <p class="mb-8">
                            In a world that is increasingly digital, your organization’s identity is the cornerstone of its success. With Proffid's cutting-edge Digital ID platform, we offer a seamless solution to transition your organization into the modern era. Our platform is designed to give your employees, teams, and even external stakeholders a secure and verified digital identity, ensuring both trust and security in every interaction.
                        </p>
                        <!--end::Text-->

                        <!--begin::Text-->
                        <p class="m-0">
                            Whether you're looking to create verified digital business cards for employees, manage your organization’s information in one place, or enable employees with tools to share their digital identities securely, Proffid has you covered. Our platform is designed to simplify, secure, and enhance the way your organization manages its identity.
                        </p>
                        <!--end::Text-->
                    </div>
                </div>
            ...
            <div class="mb-0">
                <div class="container-xxl">
                    <h3 class="fs-lg-2tx fs-2x text-gray-900 text-center mb-7 mb-lg-16 lh-base position-relative z-index-2" id="features">
                        Unlock the Power of Digital Identity with These Key Features
                    </h3>
                            ...
                            <div class="pt-6">
                                <div class="d-flex align-items-top position-relative z-index-2 mb-7 mb-lg-16">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="text-gray-700 fw-semibold fs-4">Empower your employees with modern, verifiable digital business cards that are instantly shareable, improving networking and interaction in the digital era.</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-top position-relative z-index-2 mb-7 mb-lg-16">
                                    <div class="symbol symbol-50px me-5 me-lg-9 pt-1">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="text-gray-900 fs-3 fw-bold mb-3">Centralized Digital ID Directory</div>
                                        <span class="text-gray-700 fw-semibold fs-4">Maintain a centralized and secure directory of your employees' digital IDs. Quickly access their verified profiles, contact details, and important roles within the organization.</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-top position-relative z-index-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="text-gray-900 fs-3 fw-bold mb-3">Seamless Organization Management</div>
                                        <span class="text-gray-700 fw-semibold fs-4">Manage your organization's entire digital ecosystem—employee roles, permissions, and profiles—using a single, intuitive dashboard that offers both security and flexibility.</span>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <!-- Repeat for second column if needed -->
                        <div class="col-md-6">
                            <div class="pt-6">
                                <div class="d-flex align-items-top position-relative z-index-2 mb-7 mb-lg-16">
                                    <div class="symbol symbol-50px me-5 me-lg-9 pt-1">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="text-gray-900 fs-3 fw-bold mb-3">Instant Identity Verification</div>
                                        <span class="text-gray-700 fw-semibold fs-4">Empower your team with instant identity verification. Eliminate fraud and increase trust by validating digital IDs for employees and external stakeholders, ensuring every interaction is safe and secure.</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-top position-relative z-index-2 mb-7 mb-lg-16">
                                    <div class="symbol symbol-50px me-5 me-lg-9 pt-1">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="text-gray-900 fs-3 fw-bold mb-3">Data-Driven Analytics</div>
                                        <span class="text-gray-700 fw-semibold fs-4">Gain valuable insights from your organization's digital identity data. Track usage patterns, monitor employee activity, and ensure your organization is always in compliance with identity standards.</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-top position-relative z-index-2">
                                    <div class="symbol symbol-50px me-5 me-lg-9 pt-1">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="text-gray-900 fs-3 fw-bold mb-3">Cloud-Based Integration</div>
                                        <span class="text-gray-700 fw-semibold fs-4">Easily integrate Proffid’s Digital ID platform with your existing cloud systems, ensuring a smooth, frictionless transition without disrupting your current operations.</span>
                                    </div>
                                </div>
                            </div>
                        </div>
