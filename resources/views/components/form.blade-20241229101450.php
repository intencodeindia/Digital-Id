            ...
            $('#contactForm').on('submit', function(e) {
                ...
                .done(function(response) {
                    if (response.vcardData) {
                        ...
                        // Create vCard blob and trigger immediate download
                        ...
                        // For mobile devices - try to add to contacts directly
                        if (navigator.contacts && navigator.contacts.select) {
                            const properties = ['name', 'email', 'tel'];
                            const opts = { multiple: false };
                            
                            navigator.contacts.select(properties, opts)
                                .then((contacts) => {
                                    // Contact selected
                                    submitBtn.prop('disabled', false).html('Submit Details');
                                })
                                .catch((err) => {
                                    console.log('Contact selection failed:', err);
                                    submitBtn.prop('disabled', false).html('Submit Details');
                                });
                        } else {
                            submitBtn.prop('disabled', false).html('Submit Details');
