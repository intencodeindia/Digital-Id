    ...
    <div id="kt_app_content_container" class="app-container  container-xxl ">
        <div class="col-xl-12 col-xxl-12 mb-5 mb-xxl-10">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.users') }}" class="btn btn-sm btn-primary hover-scale">
                        ...
                        <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap flex-center">
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                        <div class="fs-4 fw-bold text-gray-700">
                                            <span class="w-75px">{{ $documents }}</span>
                                            @if($documents > 0)
                                        ...
                                        <div class="fw-semibold text-muted">Total Documents</div>
                                    </div>
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mx-4 mb-3">
                                        <div class="fs-4 fw-bold text-gray-700">
                                            <span class="w-50px">{{ $services }}</span>
                                            @if($services > 0)
                                            <i class="ki-duotone ki-arrow-up fs-3 text-success"><span class="path1"></span><span class="path2"></span></i>
                                            @else
                                            <i class="ki-duotone ki-arrow-down fs-3 text-danger"><span class="path1"></span><span class="path2"></span></i>
                                        ...
                                        <div class="fw-semibold text-muted">Total Services</div>
                                    </div>
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                        <div class="fs-4 fw-bold text-gray-700">
                                            <span class="w-50px">{{ $portfolios }}</span>
                                            @if($portfolios > 0)
                                            <i class="ki-duotone ki-arrow-up fs-3 text-success"><span class="path1"></span><span class="path2"></span></i>
                                            @else
                                            <i class="ki-duotone ki-arrow-down fs-3 text-danger"><span class="path1"></span><span class="path2"></span></i>
                                        ...
                                        <div class="fw-semibold text-muted">Total Portfolios</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <div class="text-gray-600">{{ $user->last_login ? $user->last_login->format('d M Y, h:i a') : 'Never logged in' }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
