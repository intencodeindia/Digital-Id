                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card mb-5 mt-5">
                            <div class="card-body pt-9 pb-0">
                                ...
                                @if($services->count() > 0)
                                <div class="mb-5">
                                    <h2 class="fs-5 text-gray-800 mb-4">Services</h2>
                                    <div class="row g-4">
                                ...
                                <div class="mb-5">
                                    <h2 class="fs-5 text-gray-800 mb-4">Featured Work</h2>
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card h-100 shadow-sm hover-elevate-up">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text text-gray-600">{{ Str::limit($portfolio->description, 100) }}</p>
                                                    @if($portfolio->price)
